...
def Solution(ar):
    ...
    if len(negatives) >= 2 and len(positives) >= 3:
        return max( negatives[0] * negatives[1] * positives[0], negatives[0] * negatives[1] * positives[1],  positives[0] * positives[1] * positives[2])
...
# Return 500
print(Solution([-10, -10, 5, 4, 3, 2, 1]))

# Return 60
print(Solution([-1, 5, 4, 3, 2, 1]))