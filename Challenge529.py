"""
Given a string, split it into as few strings as
possible such that each string is a palindrome.
...
# Return ['racecar', 'anna', 'kayak']
print(Solution("racecarannakayak"))
# Return ['a', 'b', 'c']
print(Solution("abc"))
# Return ['t', 'h', 'isi', 's', 'a', 't', 'e', 's', 't']
print(Solution("thisisatest"))
# Return ['tacocat'] 
