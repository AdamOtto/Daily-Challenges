...
Each song is represented as an integer, and more preferred songs
appear earlier in each list. For example, the list [4, 1, 7]
indicates that a user likes song 4 the best, followed by songs 1 and 7.
...
# Returns [1, 3, 7, 9, 2, 5, 6]
in1 = [[1, 7, 3], [2, 1, 6, 7, 9], [3, 9, 5]]
print(Solution(in1))

# Returns [4, 3, 6, 1, 5, 2, 7]
in1 = [[1, 2, 3, 4], [4, 5, 6, 7], [3, 4, 6, 7]]
print(Solution(in1))