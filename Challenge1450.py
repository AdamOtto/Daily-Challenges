"""
The Tower of Hanoi is a puzzle game with three rods and n disks,
...
complete the Tower of Hanoi. You should assume that the rods are numbered,
...
def Helper(n, from_rod, to_rod, other_rod):
    if n == 0:
        return
    Helper(n - 1, from_rod, other_rod, to_rod)
    print("Move disk",n,"from",from_rod,"to",to_rod)
    Helper(n - 1, other_rod, to_rod, from_rod)
