"""
Given a list of words, return the shortest
...
print(Solution(["dog", "cat", "apple", "apricot", "fish"]))

# Return ['hell', 'help', 'hem', 'hear', 'heat', 'has', 'har']
print(Solution(["hello", "help", "hem", "hash", "harp", "heart", "hearth", "heat"]))