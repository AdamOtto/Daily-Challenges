...
or an empty space. Write an algorithm that determines into
how many regions the slashes divide the space.
...
this divides the grid into three triangles, so you should return 3.
