...
The goal is to find as many words as possible that can be
formed by a sequence of adjacent letters in the grid,
...
# Return ['test', 'avast', 'most', 'love', 'toe', 'roy', 'set', 'troy', 'your', 'tom', 'syv']
in1 = [ ['a', 'v', 'e', 'u'],
        ['a', 'y', 'o', 'r'],
        ['e', 's', 't', 'l'],
        ['t', 'o', 'm', 'i']]
in2 = ['test', 'goat','avast', 'no', 'ear', 'hold', 'very', 'tiger', 'most', 'learn', 'fear', 'love', 'toe', 'roy', 'set', 'job', 'troy', 'your', 'tom', 'syv']
